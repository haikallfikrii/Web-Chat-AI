...
function billing_plan_definitions(): array
{
    ...
    $defs = [
        ...
        'byok_starter_monthly' => [
            ...
            'api_key_source' => 'user', 'name' => 'Starter BYOK',
        ...
        'byok_starter_yearly' => [
            ...
            'api_key_source' => 'user', 'name' => 'Starter BYOK',
            'price_usd' => 19 * $annualFactor, 'price_display' => '$' . (19 * $annualFactor),
            ...
            'show_watermark' => false, 'remove_branding' => true, 'subscription_status' => 'active',
            'message_quota_limit' => 0, 'max_websites' => 1, 'highlight' => false,
            'cta' => 'Starter BYOK Annual',
            'features' => ['Everything in Starter monthly', '2 months free vs monthly', 'Annual invoice'],
        ],
        'byok_pro_monthly' => [
            'code' => 'byok_pro_monthly', 'plan_type' => 'byok_pro', 'track' => 'byok',
            'api_key_source' => 'user', 'name' => 'Pro BYOK',
        ...
        'byok_pro_yearly' => [
            ...
            'api_key_source' => 'user', 'name' => 'Pro BYOK',
            'price_usd' => 39 * $annualFactor, 'price_display' => '$' . (39 * $annualFactor),
            'interval' => 'year', 'billing_note' => 'billed annually',
            'stripe_price_id' => config_env('STRIPE_PRICE_BYOK_PRO_YEARLY', config_env('STRIPE_PRICE_PRO_YEARLY', '')),
            'show_watermark' => false, 'remove_branding' => true, 'subscription_status' => 'active',
            'message_quota_limit' => 0, 'max_websites' => 5, 'highlight' => false,
            'cta' => 'Pro BYOK Annual',
            'features' => ['Everything in Pro monthly', '2 months free vs monthly'],
        ],
        'byok_agency_monthly' => [
            'code' => 'byok_agency_monthly', 'plan_type' => 'byok_agency', 'track' => 'byok',
            'api_key_source' => 'user', 'name' => 'Agency BYOK',
        ...
        'byok_agency_yearly' => [
            ...
            'api_key_source' => 'user', 'name' => 'Agency BYOK',
            'price_usd' => 89 * $annualFactor, 'price_display' => '$' . (89 * $annualFactor),
            'interval' => 'year', 'billing_note' => 'billed annually',
            'stripe_price_id' => config_env('STRIPE_PRICE_BYOK_AGENCY_YEARLY', ''),
            'show_watermark' => false, 'remove_branding' => true, 'subscription_status' => 'active',
            'message_quota_limit' => 0, 'max_websites' => 25, 'highlight' => false,
            'cta' => 'Agency BYOK Annual',
            'features' => ['Everything in Agency monthly', '2 months free vs monthly'],
        ],
        // ── Managed AI ───────────────────────────────────────
        'managed_starter_monthly' => [
            'code' => 'managed_starter_monthly', 'plan_type' => 'managed_starter', 'track' => 'managed',
            'api_key_source' => 'system', 'name' => 'Starter Managed',
            ...
            'cta' => 'Start Managed',
            'features' => ['3,000 AI messages / month included', '1 website · plug & play', 'GPT-4o-mini class models', 'No API key required', 'Telegram alerts'],
        ],
        'managed_starter_yearly' => [
            'code' => 'managed_starter_yearly', 'plan_type' => 'managed_starter', 'track' => 'managed',
            'api_key_source' => 'system', 'name' => 'Starter Managed',
            'price_usd' => 29 * $annualFactor, 'price_display' => '$' . (29 * $annualFactor),
            'interval' => 'year', 'billing_note' => 'billed annually',
            'stripe_price_id' => config_env('STRIPE_PRICE_MANAGED_STARTER_YEARLY', ''),
            'show_watermark' => true, 'remove_branding' => false, 'subscription_status' => 'active',
            'message_quota_limit' => 3000, 'max_websites' => 1, 'highlight' => false,
            'cta' => 'Managed Annual',
            'features' => ['3,000 messages/mo quota', '2 months free vs monthly'],
        ],
        'managed_pro_monthly' => [
            'code' => 'managed_pro_monthly', 'plan_type' => 'managed_pro', 'track' => 'managed',
            'api_key_source' => 'system', 'name' => 'Growth Managed',
        ...
        'managed_pro_yearly' => [
            ...
            'api_key_source' => 'system', 'name' => 'Growth Managed',
            'price_usd' => 59 * $annualFactor, 'price_display' => '$' . (59 * $annualFactor),
            'interval' => 'year', 'billing_note' => 'billed annually',
            'stripe_price_id' => config_env('STRIPE_PRICE_MANAGED_PRO_YEARLY', ''),
            'show_watermark' => false, 'remove_branding' => true, 'subscription_status' => 'active',
            'message_quota_limit' => 4000, 'max_websites' => 3, 'highlight' => false,
            'cta' => 'Growth Annual',
            'features' => ['4,000 messages/mo', '2 months free vs monthly'],
        ],
        'managed_agency_monthly' => [
            'code' => 'managed_agency_monthly', 'plan_type' => 'managed_agency', 'track' => 'managed',
            'api_key_source' => 'system', 'name' => 'Business Managed',
        ...
        'managed_agency_yearly' => [
            ...
            'api_key_source' => 'system', 'name' => 'Business Managed',
            'price_usd' => 129 * $annualFactor, 'price_display' => '$' . (129 * $annualFactor),
            'interval' => 'year', 'billing_note' => 'billed annually',
            'stripe_price_id' => config_env('STRIPE_PRICE_MANAGED_AGENCY_YEARLY', ''),
            'show_watermark' => false, 'remove_branding' => true, 'subscription_status' => 'active',
            'message_quota_limit' => 12000, 'max_websites' => 10, 'highlight' => false,
            'cta' => 'Business Annual',
            'features' => ['12,000 messages/mo', '2 months free vs monthly'],
        ],
    ];

    // Legacy Stripe plan codes (backward compatible)
    $legacy = [
