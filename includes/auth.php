...
function send_password_reset_email(string $to_email, string $reset_link, ?string &$error = null): bool
{
    require_once __DIR__ . '/mail.php';
    return send_password_reset_email_html($to_email, $reset_link, get_lang(), $error);
}
