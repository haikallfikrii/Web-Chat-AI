...
function dash_text(string $lang): array {
    $all = [
        'en' => [
            ...
            'domain_hint' => 'Use full URLs with <code>https://</code> (e.g. your WordPress site). Include both <code>www</code> and non-www. Use <code>*</code> only for testing. Required for visitors — not only wp-admin.',
        ...
        'id' => [
            ...
            'domain_hint' => 'Isi URL lengkap dengan <code>https://</code> (situs WordPress/landing tamu). Sertakan versi <code>www</code> dan tanpa www. <code>*</code> hanya untuk uji. Harus domain pengunjung, bukan hanya wp-admin.',
